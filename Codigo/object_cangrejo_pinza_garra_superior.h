...
#ifndef OBJECT_CANGREJO_PINZA_GARRA_SUPERIOR_H
#define OBJECT_CANGREJO_PINZA_GARRA_SUPERIOR_H
...
class CangrejoPinzaGarraSuperior : public ObjectDibujable
{
private:
