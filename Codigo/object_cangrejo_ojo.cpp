...
void CangrejoOjo::create(const float radius, const unsigned int loops, 
	...
	glm::mat4 &projection_matrix)
{
	...
	else fprintf(stderr, "Uniform variable TexCangrejoOjo not found!\n");
	...
	else fprintf(stderr, "Uniform variable NormalMapTexCangrejoOjo not found!\n");
