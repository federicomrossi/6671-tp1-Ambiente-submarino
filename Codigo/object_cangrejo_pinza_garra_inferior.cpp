...
// Constructor
CangrejoPinzaGarraInferior::CangrejoPinzaGarraInferior()
{
...
// Crea un objeto
void CangrejoPinzaGarraInferior::create()
{
	// Cargamos la textura
	...
	float curvatura_sup_pc1y = -0.05;

	float curvatura_sup_pc2x = 6.0;
	float curvatura_sup_pc2y = -0.9;

	float curvatura_sup_pc3x = 10.0;
	float curvatura_sup_pc3y = 0.1;
	...
	float curvatura_inf_pc0x = 0.0001;
	float curvatura_inf_pc0y = 0.0001;

	float curvatura_inf_pc1x = 7.0;
	float curvatura_inf_pc1y = -1.2;

	float curvatura_inf_pc2x = 9.0;
	float curvatura_inf_pc2y = -0.9;

	float curvatura_inf_pc3x = 10.0;
	float curvatura_inf_pc3y = 0.1;
...
void CangrejoPinzaGarraInferior::render(glm::mat4 model_matrix, glm::mat4 &view_matrix, 
	glm::mat4 &projection_matrix)
{
	...
	else fprintf(stderr, "Uniform variable TexCangrejoPinzaGarraInferior not found!\n");
	...
	else fprintf(stderr, "Uniform variable NormalMapTexCangrejoPinzaGarraInferior not found!\n");
