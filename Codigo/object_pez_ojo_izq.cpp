...
void PezOjoIzq::create(const float radius, const unsigned int loops, 
...
void PezOjoIzq::render(glm::mat4 model_matrix, glm::mat4 &view_matrix, 
	glm::mat4 &projection_matrix)
{
	...
	else fprintf(stderr, "Uniform variable TexPezOjoIzq not found!\n");
	...
	else fprintf(stderr, "Uniform variable NormalMapTexPezOjoIzq not found!\n");
