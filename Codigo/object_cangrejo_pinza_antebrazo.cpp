	...
	glm::mat4 &projection_matrix)
{
	...
	else fprintf(stderr, "Uniform variable TexCangrejoPinzaAntebrazo not found!\n");
	...
	else fprintf(stderr, "Uniform variable NormalMapTexCangrejoPinzaAntebrazo not found!\n");
